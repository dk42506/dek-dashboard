...
INSERT INTO "new_AdminSettings" ("autoBackup", "backupFrequency", "businessAddress", "businessEmail", "businessName", "businessPhone", "businessWebsite", "clientUpdateNotifications", "compactMode", "createdAt", "currency", "dateFormat", "defaultClientType", "displayName", "emailNotifications", "freshbooksAccessToken", "freshbooksAccountId", "freshbooksAutoSync", "freshbooksClientId", "freshbooksClientSecret", "freshbooksRefreshToken", "freshbooksSyncFrequency", "id", "monthlyReportEmails", "sessionTimeout", "systemAlerts", "theme", "timezone", "updatedAt", "userId", "websiteMonitoringAlerts") SELECT "autoBackup", "backupFrequency", "businessAddress", "businessEmail", "businessName", "businessPhone", "businessWebsite", "clientUpdateNotifications", "compactMode", "createdAt", "currency", "dateFormat", "defaultClientType", "displayName", "emailNotifications", "freshbooksAccessToken", "freshbooksAccountId", "freshbooksAutoSync", "freshbooksClientId", "freshbooksClientSecret", "freshbooksRefreshToken", "freshbooksSyncFrequency", "id", "monthlyReportEmails", "sessionTimeout", "systemAlerts", "theme", "timezone", "updatedAt", "userId", "websiteMonitoringAlerts" FROM "AdminSettings";
